...
# ============================ Геттеры ============================
# Координата X инопланетянина obj
def getInvadersX(obj):
    return cnv.coords(obj[0])[0]

# Координата Y инопланетянина obj
...
# Объект вражеской ракеты Canvas
invadersRocket = None
# Увеличение скорости с каждым кадром
invadersRocketSpeedScale = 1.05
# Скорость ракеты по умолчанию
invadersRocketSpeedDefault = 1
# Скорость ракеты. Больше - быстрее
invadersRocketSpeed = invadersRocketSpeedDefault
...
penalty = 0     # Штрафы
lives = 3       # Жизни
playGame = False            # Идёт ли игра?
defaultName = "Anonymous"   # Имя по умолчанию
